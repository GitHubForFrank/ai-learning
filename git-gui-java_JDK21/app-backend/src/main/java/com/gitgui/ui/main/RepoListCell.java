...
public class RepoListCell extends ListCell<RepoListItem> {
    ...
    public RepoListCell(Consumer<RepoListItem> onToggleFavorite) {
        ...
        favoriteButton.getStyleClass()
                      .add("repo-cell-favorite-button");
        ...
        root.prefWidthProperty()
            .bind(javafx.beans.binding.Bindings.max(this.widthProperty(), MIN_ROOT_WIDTH));
    ...
    protected void updateItem(RepoListItem item, boolean empty) {
        ...
        // Tooltip 显示完整路径便于识别
        setTooltip(new Tooltip(item.getRepoMeta()
                                   .getRepoPath()));
